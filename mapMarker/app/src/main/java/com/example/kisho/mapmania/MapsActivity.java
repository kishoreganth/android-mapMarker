package com.example.kisho.mapmania;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in chennai and move the camera  -34, 151
        ...
        mMap.addMarker(new MarkerOptions().position(mumbai).title("Marker in Chennai"));
        //Sydney
